...
export const metadata: Metadata = {
  title: 'Tools & Products — AI Audit Engine & Media Processor',
  description:
    'Explore Eusopht’s in-house products: Reportly, an AI-powered financial audit engine, and MergeMagic, a high-speed video merge API. Proof of the engineering we bring to every build.',
  alternates: { canonical: '/tools' },
  openGraph: {
    title: 'Eusopht Products & Tools',
