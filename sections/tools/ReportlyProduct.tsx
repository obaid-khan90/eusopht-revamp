      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mt-16 grid grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          <AnimatedSection delay={0.1}>
            <h3 className="mb-6 text-lg font-bold text-text-primary">Why Teams Use Reportly</h3>
            <div className="flex flex-col gap-4">
              {features.map((f) => (
                <div
                  key={f.title}
                  className="flex gap-4 rounded-2xl border border-border bg-bg p-5 hover:border-accent/30 transition-colors"
                >
