    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-6 pt-32 pb-20">
        ...
        <motion.div variants={container} initial="hidden" animate="visible" className="max-w-3xl">
          ...
          >
            The Eusopht <span className="text-accent">Blog</span>
          </motion.h1>
          <motion.p variants={item} className="mt-6 max-w-2xl text-base leading-relaxed text-text-secondary sm:text-lg">
            Insights from the front lines of software development — perspectives on custom software, AI development, automation, and building products that scale.
          </motion.p>
        </motion.div>
      </div>
    </section>
